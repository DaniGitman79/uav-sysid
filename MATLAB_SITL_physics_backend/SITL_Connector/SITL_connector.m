...
function SITL_connector(state,init_function,physics_function,max_timestep)
    ...
    % Init the UDP port
    u = pnet('udpsocket',9002);        % öffnet UPD-Socket, Matlab lauscht jetzt auf UDP: 9002
    pnet(u,'setwritetimeout',1);       % Schreibtimeout Matlabseitig 
    pnet(u,'setreadtimeout',0);        % 0 heißt hurz hören, weiter nicht warten
