...
clearvars
close all
% Add the MATLAB_SITL_physics_backend folder relative to this script's location
scriptFile = mfilename('fullpath');
if isempty(scriptFile)
    scriptFile = which('SIM_multicopter');
end
if ~isempty(scriptFile)
    scriptDir = fileparts(scriptFile);
else
    scriptDir = pwd; % fallback to current folder
end
...
% the structure can have any other felids required for the phdysics model
