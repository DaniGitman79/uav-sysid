...
## 
## Makefile     : Copter.mk
## Generated on : Sat Feb 07 14:35:31 2026
## Final product: ./Copter_acc.lib
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"C:/Program Files/MATLAB/R2025a/extern/lib/win64/mingw64" -llibmex -llibmwmathutil
...
%.obj : $(START_DIR)/slprj/accel/Copter/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Copter/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Copter/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Copter/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Copter/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
