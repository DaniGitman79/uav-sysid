###########################################################################
## Makefile generated for component 'Copter'. 
## 
## Makefile     : Copter.mk
## Generated on : Sat Feb 07 14:35:33 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copter_acc.mexw64
...
START_DIR                 = C:/Users/danie/Documents/ardupilot_master/ardupilot/libraries/SITL/examples/JSON/MATLAB/Copter
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Copter_comp.rsp
CMD_FILE                  = Copter.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copter_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=Copter -DNUMST=3 -DNCSTATES=18 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/Copter/Copter_acc.c $(START_DIR)/slprj/accel/Copter/Copter_acc_data.c $(START_DIR)/slprj/accel/Copter/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = Copter_acc.obj Copter_acc_data.obj rt_nonfinite.obj c_mexapi_version.obj
...
Copter_acc.obj : $(START_DIR)/slprj/accel/Copter/Copter_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copter_acc_data.obj : $(START_DIR)/slprj/accel/Copter/Copter_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/Copter/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
